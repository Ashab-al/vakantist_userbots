...
#юзербот
api_id = "20606984"
api_hash = "b4e7c650e97450548230262cfa5db07d"
chat_id = "-1001786162328"
app = Client("2_app", api_id=api_id, api_hash=api_hash, 
             device_model="Linux 5.15.0", system_version="Ubuntu 20.04.6 LTS",
             phone_number='+447438139165', password='asxaba1#alhz')
...
async def filtering_messages_by_category(category_name, message: str, keywords: list, exceptons: list, username_customer, platform_id):
        for word_ex in exceptons:
            try:
                ...
                await app.send_message(chat_id=int(chat_id), text=f"Функция filtering_messages_by_category. (exceptons) Слово исключение: {word_ex} Ошибка: {e}")
